...
AniTOR is a lightweight, local-first streaming application that allows you to watch any `movie/TV-shows/Anime` instantly in your browser using megnet links.
...
* **Cache:** The video is stored in `AniTOR-1.0.0\temp_cache` folder.
